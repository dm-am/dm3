...
| Форум (индекс/раздел/топик/создание/редактирование) | ✅ | навигация полос " \| " унифицирована с профилем |
...
| Модерация (страницы + панель) | ✅ / 🔎 | контекстный сайдбар; 6 диалогов переведены на общий примитив (вид изменился, на осмотр); варны 0-6+автобан; баны SeniorMod+ + история |
...
**Профиль (SolohinLex):** [/users/SolohinLex](http://localhost:5173/users/SolohinLex) · /users/SolohinLex/about · /users/SolohinLex/games · /users/SolohinLex/blogs · /users/SolohinLex/topics · /users/SolohinLex/achievements · /users/SolohinLex/received-reviews · /users/SolohinLex/given-reviews · /users/SolohinLex/received-endorsements · /users/SolohinLex/given-endorsements · /users/SolohinLex/received-game-reviews · /users/SolohinLex/given-game-reviews · /users/SolohinLex/uploads
**Игры:** [/games](http://localhost:5173/games) · /games/create · [/game/aaaaa](http://localhost:5173/game/aaaaa) · /game/aaaaa/rooms/:num · /game/aaaaa/chat-rooms/:num · /game/aaaaa/characters · /game/aaaaa/characters/create · /game/aaaaa/characters/:characterId · /game/aaaaa/characters/:characterId/edit · /game/aaaaa/settings · /game/aaaaa/comments · /game/aaaaa/reviews · /game/aaaaa/post-reviews · /game/aaaaa/notes · /game/aaaaa/posts/unread · /game/aaaaa/comments/unread
