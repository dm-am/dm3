...
public interface IGameApiService
{
    ...
    Task<ListEnvelope<Dto.Games.Game>> Get(GamesQuery gamesQuery);

    /// <summary>
    /// Get user owned games
    /// </summary>
    /// <returns></returns>
    Task<ListEnvelope<Dto.Games.Game>> GetOwn();

    /// <summary>
    /// Get most popular games
    /// </summary>
    /// <returns></returns>
    Task<ListEnvelope<Dto.Games.Game>> GetPopular();
    ...
    /// <returns></returns>
    Task<Envelope<Dto.Games.Game>> Get(Guid gameId);
