...
public class GameController : ControllerBase
{
    ...
    [ProducesResponseType(typeof(ListEnvelope<Dto.Games.Game>), 200)]
    ...
    [ProducesResponseType(typeof(Envelope<Dto.Games.Game>), 200)]
    ...
    public async Task<IActionResult> PostGame([FromBody] CreateGameRequest request)
    {
        ...
        return CreatedAtRoute("GetGameDetails", new {id = result.Resource.Id}, result);
    }
