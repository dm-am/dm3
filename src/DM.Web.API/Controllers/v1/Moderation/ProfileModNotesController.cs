...
[Tags("Moderator Notes")]
public class ProfileModNotesController : ControllerBase
{
    private readonly IProfileModNoteApiService _noteApiService;

    /// <inheritdoc />
    public ProfileModNotesController(IProfileModNoteApiService noteApiService)
    {
    ...
    [HttpGet("moderation/users/{login}/notes", Name = nameof(GetUserModNotes))]
    [RequireRole(UserRole.Moderator)]
    [ProducesResponseType(typeof(ListEnvelope<ProfileModNote>), 200)]
    [ProducesResponseType(typeof(GeneralError), 401)]
    [ProducesResponseType(typeof(GeneralError), 403)]
    [ProducesResponseType(typeof(GeneralError), 404)]
    public async Task<IActionResult> GetUserModNotes(string login) =>
        Ok(await _noteApiService.GetNotes(login));
    ...
    [HttpGet("moderation/notes/{id}", Name = nameof(GetModNote))]
    [RequireRole(UserRole.Moderator)]
    [ProducesResponseType(typeof(Envelope<ProfileModNote>), 200)]
    [ProducesResponseType(typeof(GeneralError), 401)]
    [ProducesResponseType(typeof(GeneralError), 403)]
    [ProducesResponseType(typeof(GeneralError), 404)]
    ...
    /// <response code="403">Moderator role required</response>
    /// <response code="404">User not found</response>
    [HttpPost("moderation/users/{login}/notes", Name = nameof(CreateModNote))]
    [RequireRole(UserRole.Moderator)]
    [ProducesResponseType(typeof(Envelope<ProfileModNote>), 201)]
    [ProducesResponseType(typeof(BadRequestError), 400)]
    [ProducesResponseType(typeof(GeneralError), 401)]
    [ProducesResponseType(typeof(GeneralError), 403)]
    [ProducesResponseType(typeof(GeneralError), 404)]
    public async Task<IActionResult> CreateModNote(string login, [FromBody] CreateProfileModNoteRequest request)
    {
        var result = await _noteApiService.CreateNote(login, request);
        return CreatedAtRoute(nameof(GetModNote), new { id = result.Resource.Id }, result);
    }
    ...
    /// <response code="404">Note not found</response>
    [HttpPut("moderation/notes/{id}", Name = nameof(UpdateModNote))]
    [RequireRole(UserRole.Moderator)]
    [ProducesResponseType(typeof(Envelope<ProfileModNote>), 200)]
    [ProducesResponseType(typeof(BadRequestError), 400)]
    [ProducesResponseType(typeof(GeneralError), 401)]
    [ProducesResponseType(typeof(GeneralError), 403)]
    [ProducesResponseType(typeof(GeneralError), 404)]
    public async Task<IActionResult> UpdateModNote(Guid id, [FromBody] UpdateProfileModNoteRequest request) =>
    ...
    /// <response code="403">Insufficient permissions</response>
    /// <response code="404">Note not found</response>
    [HttpDelete("moderation/notes/{id}", Name = nameof(DeleteModNote))]
    [RequireRole(UserRole.Moderator)]
