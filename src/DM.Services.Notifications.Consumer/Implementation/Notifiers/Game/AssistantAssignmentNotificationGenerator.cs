...
/// <summary>
/// Notification generator for assistant assignment invitations
/// </summary>
internal class AssistantAssignmentNotificationGenerator : BaseNotificationGenerator
{
    private readonly DmDbContext _dbContext;

    /// <inheritdoc />
    public AssistantAssignmentNotificationGenerator(DmDbContext dbContext)
    {
    ...
    public override async IAsyncEnumerable<CreateNotification> Generate(Guid entityId)
    {
        var data = await _dbContext.Tokens
            .Where(t => t.TokenId == entityId && t.Type == TokenType.AssistantAssignment)
            .Select(t => new
            {
                t.UserId,
                t.EntityId,
