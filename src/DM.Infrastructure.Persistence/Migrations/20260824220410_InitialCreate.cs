        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LockoutStartUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LoginAttempts", x => x.Key);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EndsUtc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsRemoved = table.Column<bool>(type: "boolean", nullable: false),
                    RemovedUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UnreadCounters", x => new { x.UserId, x.EntityId, x.EntryType });
                });
            ...
            migrationBuilder.CreateTable(
                name: "AttributeSchemata",
                columns: table => new
                {
                    AttributeSchemaId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttributeSchemata", x => x.AttributeSchemaId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsFair = table.Column<bool>(type: "boolean", nullable: false),
                    DiceCount = table.Column<int>(type: "integer", nullable: false),
                    EdgesCount = table.Column<int>(type: "integer", nullable: false),
                    ExplosionCount = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Games_AttributeSchemata_AttributeSchemaId",
                        column: x => x.AttributeSchemaId,
                        principalTable: "AttributeSchemata",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    PollOptionId = table.Column<Guid>(type: "uuid", nullable: false),
                    VotedUtc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SecurityAuditEntryId = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    EventType = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SecurityAuditEntries", x => x.SecurityAuditEntryId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TwoFactorChallenges", x => x.ChallengeId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastAcceptedStep = table.Column<long>(type: "bigint", nullable: false),
                    RecoveryCodesIssuedUtc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    RemovalDueUtc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RecoveryCodeId = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserTwoFactorRecoveryCodes", x => x.RecoveryCodeId);
                    table.ForeignKey(
                        name: "FK_UserTwoFactorRecoveryCodes_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedUtc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    ExpirationUtc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    Persistent = table.Column<bool>(type: "boolean", nullable: false),
                    IpAddress = table.Column<string>(type: "text", nullable: true),
                    UserAgent = table.Column<string>(type: "text", nullable: true),
                    DeviceInfo = table.Column<string>(type: "text", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TopicsPerPage = table.Column<int>(type: "integer", nullable: false),
                    CommentsPerPage = table.Column<int>(type: "integer", nullable: false),
                    PostsPerPage = table.Column<int>(type: "integer", nullable: false),
                    MessagesPerPage = table.Column<int>(type: "integer", nullable: false),
                    EntitiesPerPage = table.Column<int>(type: "integer", nullable: false),
                    DiscordPreferences = table.Column<string>(type: "jsonb", nullable: true),
                    TelegramPreferences = table.Column<string>(type: "jsonb", nullable: true),
                    EmailPreferences = table.Column<string>(type: "jsonb", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("00000000-0000-0000-0003-000000000002"), "game_posts_authored", "Игровые посты во всех играх, включая удаленные", "scroll-quill", true, 1, 2, "Игровые посты" },
                    { new Guid("00000000-0000-0000-0003-000000000003"), "post_review_score_sum", "Сумма оценок игровых постов с учетом минусов", "laurels", true, 3, 3, "Рейтинг" },
                    { new Guid("00000000-0000-0000-0003-000000000004"), "games_hosted", "Игры в роли мастера или ассистента", "scepter", true, 4, 4, "Игры в роли ведущего" },
                    { new Guid("00000000-0000-0000-0003-000000000005"), "games_played", "Игры с активным или бывшим персонажем", "sword", true, 5, 5, "Игры в роли игрока" },
                    { new Guid("00000000-0000-0000-0003-000000000006"), "blogs_hosted", "Блоги в роли автора или ассистента", "book", true, 6, 6, "Блоги в роли ведущего" },
                    { new Guid("00000000-0000-0000-0003-000000000007"), "publications_authored", "Статьи в блогах, включая черновики", "papers", true, 12, 7, "Публикации" },
                    { new Guid("00000000-0000-0000-0003-000000000008"), "topics_authored", "Топики, созданные на форуме", "stabbed-note", true, 7, 8, "Топики" },
                    { new Guid("00000000-0000-0000-0003-000000000009"), "comments_authored", "Комментарии на форуме, в блогах, играх и публикациях", "discussion", true, 8, 9, "Комментарии" },
                    { new Guid("00000000-0000-0000-0003-00000000000a"), "global_chat_messages", "Сообщения в глобальном чате", "talk", true, 9, 10, "Глобальный чат" },
                    { new Guid("00000000-0000-0000-0003-00000000000b"), "likes_received", "Лайки на топиках, публикациях, комментариях и сообщениях чата", "heart-organ", true, 13, 11, "Лайки" },
                    { new Guid("00000000-0000-0000-0003-00000000000c"), "game_drops", "Игры, покинутые добровольно (смерть персонажа и изгнание мастером не считаются)", "walking-boot", true, 11, 12, "Дропы" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("00000000-0000-0000-0001-000000000001"), "contest_first", "Первое место в конкурсе", "trophy-cup", true, 1, 1, "Литконкурс" },
                    { new Guid("00000000-0000-0000-0001-000000000002"), "contest_second", "Второе место в конкурсе", "trophy-cup", true, 2, 2, "Литконкурс" },
                    { new Guid("00000000-0000-0000-0001-000000000003"), "contest_third", "Третье место в конкурсе", "trophy-cup", true, 3, 3, "Литконкурс" },
                    { new Guid("00000000-0000-0000-0001-000000000004"), "popular_vote", "Лучшая работа по голосованию участников", "ribbon-medal", true, 4, 1, "Народное признание, например" },
                    { new Guid("00000000-0000-0000-0001-000000000005"), "best_critic", "Лучшие рецензии конкурса по решению жюри", "quill-ink", true, 5, 1, "Лучший критик" },
                    { new Guid("00000000-0000-0000-0001-000000000006"), "guesser", "Больше всех угаданных авторов конкурсных работ", "magnifying-glass", true, 6, 1, "Угадайка" },
                    { new Guid("00000000-0000-0000-0001-000000000007"), "honorary_goblin", "Годы службы сообществу в команде гоблинов", "goblin", true, 7, 5, "Почетный гоблин" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "AccessPolicy", "AvatarUploadId", "BirthdayDate", "BlacklistSettings", "CreatedUtc", "DiscordId", "Email", "Gender", "Info", "IsRemoved", "IsUnderModerationWatch", "LastActivityUtc", "Location", "Name", "PasswordHash", "PasswordHashVersion", "PendingEmail", "QualityRating", "QuantityRating", "RatingDisabled", "Role", "Salt", "ShowBirthday", "Status", "TelegramId", "Username" },
                values: new object[] { new Guid("00000000-0000-0000-0000-000000000001"), 0, null, null, 19, new DateTimeOffset(new DateTime(2020, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), null, "system@dm.local", 0, null, false, false, null, null, null, "", 0, null, 0, 0, true, 6, "", false, null, null, "Робот-Администратор" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("00000000-0000-0000-0002-00000000000a"), new Guid("00000000-0000-0000-0003-000000000003"), "RATING_250", 250, 2, "Самобытный талант" },
                    ...
                    { new Guid("00000000-0000-0000-0002-00000000000c"), new Guid("00000000-0000-0000-0003-000000000003"), "RATING_1000", 1000, 4, "Мастодонт ремесла" },
                    ...
                    { new Guid("00000000-0000-0000-0002-000000000025"), new Guid("00000000-0000-0000-0003-00000000000d"), "BANS_1", 1, 1, "Выпавший из гнезда" },
                    { new Guid("00000000-0000-0000-0002-000000000026"), new Guid("00000000-0000-0000-0003-00000000000d"), "BANS_3", 3, 2, "Крякнувший лишнего" },
                    ...
                    { new Guid("00000000-0000-0000-0002-000000000029"), new Guid("00000000-0000-0000-0003-00000000000c"), "DROPS_1", 1, 1, "Покинувший строй" },
            ...
            migrationBuilder.InsertData(
                table: "Boards",
                columns: new[] { "BoardId", "Alias", "CreateTopicPolicy", "Description", "LastTopicAuthorId", "LastTopicCreatedUtc", "LastTopicId", "LastTopicNumber", "LastTopicTitle", "Order", "Title", "TopicsCount", "ViewPolicy" },
                values: new object[] { new Guid("00000000-0000-0000-0000-000000000001"), "general", 32, "Жизнь сообщества и решения администрации", new Guid("00000000-0000-0000-0000-000000000001"), new DateTimeOffset(new DateTime(2020, 1, 1, 0, 0, 1, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), new Guid("00000000-0000-0000-0000-000000000100"), 2, "Обсуждение действий администрации", 1, "Общий", 2, 64 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("00000000-0000-0000-0000-000000000001"), "Простая система с кубиком d6", 1, 2, new Guid("00000000-0000-0000-0005-000000000001"), "Black Bird Pie" },
                    { new Guid("00000000-0000-0000-0000-000000000002"), "Семейство Dungeons & Dragons", 2, 4, new Guid("00000000-0000-0000-0005-000000000001"), "D&D" },
                    { new Guid("00000000-0000-0000-0000-000000000003"), "Пятая редакция Dungeons & Dragons", 3, 7, new Guid("00000000-0000-0000-0005-000000000001"), "D&D 5e" },
                    { new Guid("00000000-0000-0000-0000-000000000004"), "Системы на основе процентного броска", 4, 8, new Guid("00000000-0000-0000-0005-000000000001"), "d100" },
                    { new Guid("00000000-0000-0000-0000-000000000005"), "Система для совместного создания мира", 5, 9, new Guid("00000000-0000-0000-0005-000000000001"), "Dawn of Worlds" },
                    { new Guid("00000000-0000-0000-0000-000000000006"), "Адаптация сеттинга Fallout", 6, 10, new Guid("00000000-0000-0000-0005-000000000001"), "Fallout" },
                    { new Guid("00000000-0000-0000-0000-000000000007"), "Без комментариев", 7, 11, new Guid("00000000-0000-0000-0005-000000000001"), "FATAL" },
                    { new Guid("00000000-0000-0000-0000-000000000008"), "Нарративная система с аспектами и фейт-пойнтами", 8, 12, new Guid("00000000-0000-0000-0005-000000000001"), "Fate" },
                    { new Guid("00000000-0000-0000-0000-000000000009"), "Универсальный движок для реализации практически любого концепта", 9, 14, new Guid("00000000-0000-0000-0005-000000000001"), "FUDGE" },
                    { new Guid("00000000-0000-0000-0000-00000000000a"), "Универсальная система на базе броска 3d6 vs Сложность", 10, 16, new Guid("00000000-0000-0000-0005-000000000001"), "GURPS" },
                    { new Guid("00000000-0000-0000-0000-00000000000b"), "Система от R. Talsorian Games (Cyberpunk 2020 и другие)", 11, 17, new Guid("00000000-0000-0000-0005-000000000001"), "Interlock" },
                    { new Guid("00000000-0000-0000-0000-00000000000c"), "Система для создания эпических историй", 12, 18, new Guid("00000000-0000-0000-0005-000000000001"), "Microscope" },
                    { new Guid("00000000-0000-0000-0000-00000000000d"), "Pathfinder первой редакции", 13, 19, new Guid("00000000-0000-0000-0005-000000000001"), "Pathfinder 1e" },
                    { new Guid("00000000-0000-0000-0000-00000000000e"), "Pathfinder второй редакции", 14, 20, new Guid("00000000-0000-0000-0005-000000000001"), "Pathfinder 2e" },
                    { new Guid("00000000-0000-0000-0000-00000000000f"), "Нарративные системы на базе 2d6 vs Сложность", 15, 21, new Guid("00000000-0000-0000-0005-000000000001"), "PbtA" },
                    { new Guid("00000000-0000-0000-0000-000000000010"), "Минималистичная комедийная система", 16, 22, new Guid("00000000-0000-0000-0005-000000000001"), "Risus" },
                    { new Guid("00000000-0000-0000-0000-000000000011"), "Легковесная универсальная система — Fast! Furious! Fun!", 17, 23, new Guid("00000000-0000-0000-0005-000000000001"), "Savage Worlds" },
                    { new Guid("00000000-0000-0000-0000-000000000012"), "Sci-fi спин-офф Pathfinder", 18, 24, new Guid("00000000-0000-0000-0005-000000000001"), "Starfinder 1e" },
                    { new Guid("00000000-0000-0000-0000-000000000013"), "Starfinder второй редакции", 19, 25, new Guid("00000000-0000-0000-0005-000000000001"), "Starfinder 2e" },
                    { new Guid("00000000-0000-0000-0000-000000000014"), "Системы по вселенной Warhammer", 20, 26, new Guid("00000000-0000-0000-0005-000000000001"), "Warhammer" },
                    { new Guid("00000000-0000-0000-0000-000000000015"), "Мир Тьмы: Storyteller, Storytelling и Chronicles of Darkness", 21, 27, new Guid("00000000-0000-0000-0005-000000000001"), "World of Darkness" },
                    { new Guid("00000000-0000-0000-0000-000000000016"), "Оригинальная система от мастера игры", 22, 28, new Guid("00000000-0000-0000-0005-000000000001"), "Авторская" },
                    { new Guid("00000000-0000-0000-0000-000000000017"), "Психологическая детективная командная игра", 23, 29, new Guid("00000000-0000-0000-0005-000000000001"), "Мафия" },
                    { new Guid("00000000-0000-0000-0000-000000000018"), "Игра без формальной системы правил", 24, 30, new Guid("00000000-0000-0000-0005-000000000001"), "Словеска" },
                    { new Guid("00000000-0000-0000-0000-000000000019"), "Отечественная система ролевых игр", 25, 31, new Guid("00000000-0000-0000-0005-000000000001"), "Эра Водолея" },
                    ...
                    { new Guid("00000000-0000-0000-0000-000000000042"), "Движок Modiphius: пул из двух d20 против характеристики", 66, 0, new Guid("00000000-0000-0000-0005-000000000001"), "2d20" },
                    { new Guid("00000000-0000-0000-0000-000000000043"), "Первая и вторая редакции Dungeons & Dragons", 67, 1, new Guid("00000000-0000-0000-0005-000000000001"), "AD&D" },
                    { new Guid("00000000-0000-0000-0000-000000000044"), "Движок Monte Cook Games: сложность против броска d20", 68, 3, new Guid("00000000-0000-0000-0005-000000000001"), "Cypher" },
                    { new Guid("00000000-0000-0000-0000-000000000045"), "Третья редакция Dungeons & Dragons, включая 3.0", 69, 5, new Guid("00000000-0000-0000-0005-000000000001"), "D&D 3.5" },
                    { new Guid("00000000-0000-0000-0000-000000000046"), "Четвертая редакция Dungeons & Dragons", 70, 6, new Guid("00000000-0000-0000-0005-000000000001"), "D&D 4e" },
                    { new Guid("00000000-0000-0000-0000-000000000047"), "Forged in the Dark: системы на движке Blades in the Dark", 71, 13, new Guid("00000000-0000-0000-0005-000000000001"), "FitD" },
                    { new Guid("00000000-0000-0000-0000-000000000048"), "Детективный движок Robin Laws: улики не пропускаются на броске", 72, 15, new Guid("00000000-0000-0000-0005-000000000001"), "GUMSHOE" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttributeSchemata_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Games_AttributeSchemaId",
                table: "Games",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LoginAttempts_LastAttemptUtc",
                table: "LoginAttempts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_EventId_EventType",
                table: "Notifications",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OutboxEvents_Pending",
                table: "OutboxEvents",
                columns: new[] { "OccurredUtc", "Id" },
                filter: "\"PublishedUtc\" IS NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Polls_IsRemoved_EndsUtc",
                table: "Polls",
                columns: new[] { "IsRemoved", "EndsUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_Polls_IsRemoved_StartsUtc",
                table: "Polls",
                columns: new[] { "IsRemoved", "StartsUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SecurityAuditEntries_UserId_TimestampUtc",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UnreadCounters_EntityId_EntryType",
                table: "UnreadCounters",
                columns: new[] { "EntityId", "EntryType" });

            migrationBuilder.CreateIndex(
                name: "IX_UnreadCounters_ParentId_EntryType",
                table: "UnreadCounters",
                columns: new[] { "ParentId", "EntryType" });

            migrationBuilder.CreateIndex(
                name: "IX_UnreadCounters_RemovedUtc",
                table: "UnreadCounters",
                column: "RemovedUtc",
                filter: "\"RemovedUtc\" IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_UnreadCounters_UserId_ParentId_EntryType_IsRemoved",
                table: "UnreadCounters",
                columns: new[] { "UserId", "ParentId", "EntryType", "IsRemoved" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TwoFactorChallenges_CreatedUtc",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSessions_ExpirationUtc",
                table: "UserSessions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserTwoFactorRecoveryCodes_UserId",
                table: "UserTwoFactorRecoveryCodes",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserTwoFactors_RemovalDueUtc",
                table: "UserTwoFactors",
                column: "RemovalDueUtc",
                filter: "\"RemovalDueUtc\" IS NOT NULL");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AttributeSchemata_Users_UserId",
                table: "AttributeSchemata",
                column: "UserId",
                principalTable: "Users",
                principalColumn: "UserId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_DiceRolls_Posts_PostId",
                table: "DiceRolls",
                column: "PostId",
                principalTable: "Posts",
                principalColumn: "PostId",
