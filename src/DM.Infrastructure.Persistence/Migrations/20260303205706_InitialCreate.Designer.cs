...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DM.Infrastructure.Persistence.Entities.CrossDomain.Comment", b =>
                {
            ...
            modelBuilder.Entity("DM.Infrastructure.Persistence.Entities.CrossDomain.CommentEditHistory", b =>
                {
            ...
            modelBuilder.Entity("DM.Infrastructure.Persistence.Entities.CrossDomain.Like", b =>
                {
            ...
            modelBuilder.Entity("DM.Infrastructure.Persistence.Entities.CrossDomain.OutboxEvent", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("DM.Infrastructure.Persistence.Entities.CrossDomain.Review", b =>
                {
            ...
            modelBuilder.Entity("DM.Infrastructure.Persistence.Entities.CrossDomain.Tag", b =>
                {
            ...
            modelBuilder.Entity("DM.Infrastructure.Persistence.Entities.CrossDomain.TagGroup", b =>
                {
                    b.Property<Guid>("TagGroupId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DM.Infrastructure.Persistence.Entities.CrossDomain.Upload", b =>
                {
            ...
            modelBuilder.Entity("DM.Infrastructure.Persistence.Entities.Notepads.NotepadCategory", b =>
                {
            ...
            modelBuilder.Entity("DM.Infrastructure.Persistence.Entities.Notepads.NotepadEntry", b =>
                {
                    b.Property<Guid>("EntryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DM.Infrastructure.Persistence.Entities.Account.User", b =>
                {
                    b.HasOne("DM.Infrastructure.Persistence.Entities.CrossDomain.Upload", "AvatarUpload")
                        .WithMany()
            ...
            modelBuilder.Entity("DM.Infrastructure.Persistence.Entities.CrossDomain.CommentEditHistory", b =>
                {
                    b.HasOne("DM.Infrastructure.Persistence.Entities.CrossDomain.Comment", "Comment")
                        .WithMany("Edits")
            ...
            modelBuilder.Entity("DM.Infrastructure.Persistence.Entities.CrossDomain.Tag", b =>
                {
                    b.HasOne("DM.Infrastructure.Persistence.Entities.CrossDomain.TagGroup", "TagGroup")
                        .WithMany("Tags")
            ...
            modelBuilder.Entity("DM.Infrastructure.Persistence.Entities.Forum.Board", b =>
                {
                    ...
                    b.HasOne("DM.Infrastructure.Persistence.Entities.CrossDomain.Comment", "LastComment")
                        .WithMany()
            ...
            modelBuilder.Entity("DM.Infrastructure.Persistence.Entities.Game.Links.GameTag", b =>
                {
                    ...
                    b.HasOne("DM.Infrastructure.Persistence.Entities.CrossDomain.Tag", "Tag")
                        .WithMany("GameTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DM.Infrastructure.Persistence.Entities.Notepads.NotepadEntry", b =>
                {
                    ...
                    b.HasOne("DM.Infrastructure.Persistence.Entities.Notepads.NotepadCategory", "Category")
                        .WithMany("Entries")
