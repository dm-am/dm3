...
internal class NotificationRepository : MongoCollectionRepository<Notification>, INotificationRepository
{
    ...
    {
        // Project.Expression вместо As<UserNotification>(): As<> читает все поля
        // документа и матчит strict — у Mongo есть autogenerated _id, у DTO нет,
        // что валит запрос. Явная проекция берет только нужные поля.
