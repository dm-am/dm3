...
internal class GameIntentionResolver :
    ...
    IIntentionResolver<GameIntention, Dto.Output.Game>
{
    /// <inheritdoc />
    ...
    /// <inheritdoc />
    public bool IsAllowed(AuthenticatedUser user, GameIntention intention, Dto.Output.Game target)
    {
        ...
        return intention switch
        {
            ...
            GameIntention.CreateCharacter when user.IsAuthenticated =>
                target.Status == ModuleStatus.Active && target.Recruitment?.IsOpen == true,
