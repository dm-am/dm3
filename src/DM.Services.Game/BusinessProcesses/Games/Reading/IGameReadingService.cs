...
public interface IGameReadingService
{
    ...
    /// </summary>
    /// <returns></returns>
    Task<IEnumerable<Dto.Output.Game>> GetOwnGames();
    ...
    Task<(IEnumerable<Dto.Output.Game> games, PagingResult paging)> GetGames(GamesQuery query);
    ...
    /// <returns></returns>
    Task<Dto.Output.Game> GetGame(Guid gameId);
    ...
    /// </summary>
    /// <returns></returns>
    Task<IEnumerable<Dto.Output.Game>> GetPopularGames();
}