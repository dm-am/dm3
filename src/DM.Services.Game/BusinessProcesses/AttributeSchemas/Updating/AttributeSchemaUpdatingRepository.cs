...
/// <inheritdoc />
internal class AttributeSchemaUpdatingRepository : MongoCollectionRepository<DbAttributeSchema>, IAttributeSchemaUpdatingRepository
{
    /// <inheritdoc />
    public AttributeSchemaUpdatingRepository(DmMongoClient client) : base(client)
    {
    }
