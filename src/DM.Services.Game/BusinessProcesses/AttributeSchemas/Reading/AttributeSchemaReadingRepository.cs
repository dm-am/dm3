...
/// <inheritdoc cref="IAttributeSchemaReadingRepository" />
internal class AttributeSchemaReadingRepository :
    MongoCollectionRepository<DbSchema>,
    IAttributeSchemaReadingRepository
{
    private readonly DmDbContext _dbContext;
    private readonly IMapper _mapper;

    /// <inheritdoc />
    public AttributeSchemaReadingRepository(
