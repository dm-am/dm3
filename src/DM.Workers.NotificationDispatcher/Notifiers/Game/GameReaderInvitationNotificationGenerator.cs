...
/// </summary>
internal class GameReaderInvitationNotificationGenerator : GameInvitationNotificationGenerator
{
    /// <inheritdoc />
    ...
    /// <inheritdoc />
    protected override TokenType TokenType => TokenType.GameReaderInvitation;
