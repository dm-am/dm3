...
/// <summary>
/// Retries and counts the events this worker takes off its queue.
/// </summary>
/// <remarks>
/// Every event passes through here, which is why the counters are written on
/// this side at all: the warning a retry leaves behind was the only trace of a
/// failing generator, and it reached no dashboard and no rule.
///
