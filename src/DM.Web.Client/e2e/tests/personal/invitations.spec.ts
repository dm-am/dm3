...
test.describe('Invitations API', () => {
  test('should get my invitations', async () => {
    ...
    const response = await authContext.get(`${API_URL}/v1/users/me/invitations`);
  ...
  test('should reject non-existent invitation', async () => {
    ...
    const response = await authContext.post(`${API_URL}/v1/users/me/invitations/${fakeId}/reject`);
  ...
  test('should accept non-existent invitation', async () => {
    ...
    const fakeId = '00000000-0000-0000-0000-000000000000';
    const response = await authContext.post(`${API_URL}/v1/users/me/invitations/${fakeId}/accept`);
