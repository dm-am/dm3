...
import { UserRating, UserOnline } from "@/entities/user";
import { useCommunityStore } from "@/entities/user";
...
$grid-template: [number] 6% [username] auto [rating] 12% [online] 8% [name] 25% [location] 25%
