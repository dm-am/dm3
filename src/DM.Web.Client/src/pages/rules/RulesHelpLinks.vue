...
/**
 * RulesHelpLinks - Quick help links for the rules page
 *
  ...
  <section class="help-section">
    ...
    <div class="help-table">
      ...
      >
        ...
        <span class="help-arrow-col" aria-hidden="true">{{
          symbols.arrowRight
        }}</span>
...
.help-solution-col
  // Global `a` (Reset.sass) already provides color/hover — only the bold
  // weight for links-inside-sentences (LeadText convention) is local here.
  .help-link
    font-weight: 600
