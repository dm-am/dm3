...
.wysiwyg-content
  ...
  :deep(.tiptap)
    ...
    width: 100%
    min-height: 100%
    // Line-height and paragraph spacing come from +bbcode-content-editor
    // (SSOT): p margin 0, blank line = one full empty line box — the
    // WYSIWYG view previews exactly what the display render shows.
