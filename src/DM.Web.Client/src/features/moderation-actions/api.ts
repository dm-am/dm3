 ...
 *
 * Deliberately self-contained: shared/api/moderationApi.ts is owned by the
 * moderation-pages work stream, so this feature talks to the shared Api
 * client directly (same pattern as features/message-search/api).
 *
