...
const roleNames: Record<string, string> = {
  [UserRole.Admin]: "Тролль",
  [UserRole.SeniorModerator]: "Старший гоблин",
  [UserRole.Moderator]: "Гоблин",
  [UserRole.Mentor]: "Гоблин-нянька",
};
const userRoles = computed(() => {
  const roles = user.value?.roles.filter((r) => r in roleNames).map((r) => roleNames[r]) || [];
    ...
    <div class="profile_container">
      <div class="profile_short-info">
        ...
        <template v-else>
          ...
          />
          <profile-stat title="Пол" empty="Не указан" :modelValue="userGender" />
          <profile-stat title="День рождения" empty="Не указан" :modelValue="userBirthday" />
          <profile-stat title="Skype" empty="Не указан" :modelValue="userSkype" />
          ...
          <the-button v-if="isCurrentUser" @click="startEditProfile" class="edit-profile-btn">
