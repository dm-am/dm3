...
public class HashProviderShould
{
    ...
    public void GenerateHashBasedOnPlainPasswordAndValidSalt()
    {
        ...
        var actual = hashProvider.ComputePbkdf2("password", validSalt);
        actual.Should().NotBeEmpty();
        actual.Should().HaveCount(32); // 256 bits
    }
    ...
    public void ThrowExceptionIfSaltIsNotBase64String()
    {
        ...
        hashProvider.Invoking(p => p.ComputePbkdf2("password", invalidSalt))
            .Should().Throw<FormatException>();
    }

    [Fact]
    public void ReturnCurrentVersionAs3()
    {
        hashProvider.CurrentVersion.Should().Be(3);
    }
}