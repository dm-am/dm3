    ...
    private static void SeedTestimonials(DmDbContext db)
    {
        ...
        var testimonials = new (Guid TestimonialId, Guid UserId, string Text, int DaysAgo)[]
        {
            (TestConstants.TestTestimonialId, TestConstants.TestUserId,
                "Пришёл сюда по рекомендации друга около трёх лет назад, и с тех пор это стало моим основным хобби. Особенно нравится, что здесь можно найти игры на любой вкус — от классического фэнтези до киберпанка и постапокалипсиса. Мастера в большинстве своём отзывчивые и готовы помочь новичкам разобраться в правилах. Отдельный плюс — возможность играть в своём темпе, не подстраиваясь под чужое расписание. Конечно, бывают и неудачные игры, но это скорее исключение. В целом — отличное место для тех, кто любит писать и создавать истории вместе с другими людьми.", 120),
            ...
            (TestConstants.SecondTestimonialId, TestConstants.SecondUserId,
                "Удобный интерфейс, дружелюбное комьюнити. Нашёл здесь много интересных игр и познакомился с классными людьми.", 45),
            ...
            (TestConstants.AdditionalTestimonialIds[7], TestConstants.TestimonialUserIds[7],
                "Классное комьюнити, интересные игры, удобный сайт. Что ещё нужно?", 140),
            (TestConstants.AdditionalTestimonialIds[8], TestConstants.TestimonialUserIds[8],
                "Пришла сюда по рекомендации подруги и не пожалела. Первые дни было немного страшно — всё-таки новое место, незнакомые люди. Но оказалось, что здесь очень приветливо относятся к новичкам. Помогли разобраться с правилами, подсказали хорошие игры для старта. Сейчас у меня уже три активных персонажа в разных играх, и я планирую создать свою собственную игру в ближайшее время.", 165),
            (TestConstants.AdditionalTestimonialIds[9], TestConstants.TestimonialUserIds[9],
                "Годы идут, а DM.am остаётся любимым местом для творчества.", 200),
            ...
            (TestConstants.AdditionalTestimonialIds[11], TestConstants.TestimonialUserIds[11],
                "Не ожидал, что форумные игры могут быть настолько затягивающими! Начал полгода назад с небольшого персонажа в фэнтези-игре, а теперь уже сам вожу две игры и участвую ещё в трёх. Формат постовой игры отлично подходит для работающих людей — можно писать когда удобно, не нужно подстраиваться под чужое расписание. Сообщество отзывчивое, всегда можно найти партнёров для игры или просто пообщаться на форуме.", 260),
            ...
            (TestConstants.AdditionalTestimonialIds[13], TestConstants.TestimonialUserIds[13],
                "Площадка, на которой хочется оставаться. Здесь собрались действительно увлечённые люди, которые создают потрясающие истории. Каждая игра — это маленький мир со своими правилами и атмосферой. Очень нравится система тегов, которая помогает быстро найти игру по интересам. Отдельное спасибо разработчикам за удобный редактор постов с поддержкой форматирования.", 350),
            (TestConstants.AdditionalTestimonialIds[14], TestConstants.TestimonialUserIds[14],
                "DM — это как таверна на перекрёстке миров. Заходишь случайно, а остаёшься навсегда.", 5),
            (TestConstants.AdditionalTestimonialIds[15], TestConstants.TestimonialUserIds[15],
                "Когда создаёшь очередного персонажа, невольно вкладываешь в него частицу себя. И это прекрасно — здесь можно быть кем угодно, исследовать грани своей личности через призму выдуманных историй. За годы на площадке я создала десятки персонажей, и каждый из них научил меня чему-то новому о себе.", 42),
            ...
            (TestConstants.AdditionalTestimonialIds[19], TestConstants.TestimonialUserIds[19],
                "Раньше считал, что форумные игры — это что-то несерьёзное. Попробовал ради интереса и понял, как сильно ошибался. Здесь собрались талантливые авторы, которые создают тексты уровня профессиональных писателей. Некоторые игровые посты читаются как главы хорошего романа. Спасибо всем, кто делает эту площадку такой особенной.", 155),
            ...
            (TestConstants.AdditionalTestimonialIds[27], TestConstants.TestimonialUserIds[27],
                "DM научил меня писать. Серьёзно. Когда я только пришёл сюда, мои посты были короткими и корявыми. Но здесь окружение такое, что хочется стараться, хочется писать лучше. Читаешь посты других игроков и вдохновляешься. Сейчас, спустя несколько лет, я пишу совсем на другом уровне — и это заслуга не только моя, но и этого сообщества.", 210),
        };
