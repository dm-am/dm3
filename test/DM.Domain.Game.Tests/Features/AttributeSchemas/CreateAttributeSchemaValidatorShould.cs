...
public class CreateAttributeSchemaValidatorShould : UnitTestBase
{
    private readonly CreateAttributeSchemaValidator validator = new();

    private static CreateAttributeSpecification ValidSpecification() => new()
    {
        Title = "Strength",
    ...
    {
        var input = new CreateAttributeSchema
        {
            Title = "Valid Schema",
    ...
    [Fact]
    public void FailWhenSpecificationTitleExceedsMaxLength()
    {
        var specification = ValidSpecification();
        specification.Title = new string('a', 101);
        var input = new CreateAttributeSchema
        {
            Title = "Valid Schema",
            Type = SchemaType.Public,
    ...
    [Fact]
    public void PassWhenTextNumberListValuesAreComplete()
    {
        var specification = ValidSpecification();
        specification.Type = AttributeSpecificationType.TextNumberList;
        specification.Values =
        [
            new ListValue { Value = "Sword", Modifier = 2 },
            new ListValue { Value = "Bow", Modifier = 1 }
        ];
        var input = new CreateAttributeSchema
        {
            Title = "Valid Schema",
